...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of ring_osc_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins ring_osc_0/S00_AXI]
	connect_bd_net [get_bd_pins ring_osc_0/s00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins ring_osc_0/s00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to ring_osc_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/ring_osc_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_ring_osc_0_S00_AXI_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/ring_osc_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "ring_osc_v1_0_hw_${i}"
